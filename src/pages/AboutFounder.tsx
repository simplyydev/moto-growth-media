          ...
          <div className="space-y-6">
            <Card className="p-6 bg-card">
              ...
              <p className="text-muted-foreground">
                Full Stack Developer & Founder of MotoGrowth Media, passionate about creating innovative solutions and helping businesses grow through technology.
              </p>
            </Card>
            ...
            <Card className="p-6 bg-emerald-50 dark:bg-emerald-900/30">
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>• Full Stack Developer with expertise in MERN Stack</li>
